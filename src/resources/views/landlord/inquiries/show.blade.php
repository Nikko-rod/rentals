...
<style>
    ...
    .tenant .message-meta { text-align: left; }
    .landlord .message-meta { text-align: right; }
...
<div class="content-card">
    ...
    <div class="chat-container">
        ...
        <div class="chat-footer">
            ...
            @else
                <form action="{{ route('landlord.inquiries.reply', $inquiry) }}" method="POST">
                    @csrf
    ...
    <div style="margin-top: 1rem; text-align: right;">
        <a href="{{ route('landlord.inquiries.index') }}" class="btn-secondary">
